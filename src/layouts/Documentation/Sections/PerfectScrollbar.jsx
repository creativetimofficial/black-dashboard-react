    ...
    return (
      <div>
        ...
        <p>
          ...
          <code class="highlighter-rouge">.main-panel</code> and{" "}
          <code class="highlighter-rouge">.sidebar .sidebar-wrapper</code> so we
          ...
          <code class="highlighter-rouge">.ps-child</code> to any element that
          should have scroll.
        </p>
        <p>
