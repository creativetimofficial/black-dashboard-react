...
const Forms = () => {
  return (
    <>
      ...
      <p>
        Default checkboxes and radios are improved upon with the help of <code className="highlighter-rouge">check</code>, <b>a single class for both input types that improves the layout and behavior of their HTML elements</b>. Checkboxes are for selecting one or several options in a list, while radios are for selecting one option from many.
      </p>
      <p>Disabled checkboxes and radios are supported, but to provide a <code className="highlighter-rouge">not-allowed</code> cursor on hover of the parent <code className="highlighter-rouge">&lt;Label&gt;</code>, you’ll need to add the <code className="highlighter-rouge">.disabled</code> className to the parent <code className="highlighter-rouge">check</code>. The disabled className will also lighten the text color to help indicate the input’s state.</p>
      <h3>Default (stacked)</h3>
      <p>By default, any number of checkboxes and radios that are immediate sibling will be vertically stacked and appropriately spaced with <code className="highlighter-rouge">check</code>.</p>
      <div className="bd-example">
        <FormGroup check>
          <Label check>
            <Input type="checkbox" />{' '}
      ...
      <h3>Inline</h3>
      <p>
        Group checkboxes or radios on the same horizontal row by adding <code className="highlighter-rouge">inline</code> prop to the <code className="highlighter-rouge">FormGroup</code>.
      </p>
      <div className="bd-example">
        <FormGroup check inline>
          <Label check>
      ...
      <h2>Layout</h2>
      <p>Since Bootstrap applies
          <code className="highlighter-rouge">display: block</code> and
          <code className="highlighter-rouge">width: 100%</code> to almost all our form controls, forms will by default stack vertically. Additional classes can be used to vary this layout on a per-form basis.</p>
      <h3>Form grid</h3>
      ...
      <p>Add the <code className="highlighter-rouge">disabled</code> boolean attribute on an input to prevent user interactions and make it appear lighter.</p>
      <SyntaxHighlighter language="jsx" style={prism}>
      ...
      <div className="bd-callout bd-callout-warning">
        ...
        <p>By default, browsers will treat all native form controls (
          <code className="highlighter-rouge">&lt;input&gt;</code>,
          <code className="highlighter-rouge">&lt;select&gt;</code> and
          <code className="highlighter-rouge">&lt;button&gt;</code> elements) inside a
          <code className="highlighter-rouge">&lt;fieldset disabled&gt;</code> as disabled, preventing both keyboard and mouse interactions on them. However, if your form also includes
          <code className="highlighter-rouge">&lt;a ... className="btn btn-*"&gt;</code> elements, these will only be given a style of
          <code className="highlighter-rouge">pointer-events: none</code>. This CSS property is not yet standardized and isn’t fully supported in Opera 18 and below, or in Internet Explorer 10, and won’t prevent keyboard users from being able to focus or activate these links. So to be safe, use custom JavaScript to disable such links.</p>
      </div>
      <div className="bd-callout bd-callout-danger">
        <h4 id="cross-browser-compatibility">Cross-browser compatibility</h4>
        <p>While Bootstrap will apply these styles in all browsers, Internet Explorer 11 and below don’t fully support the
          <code className="highlighter-rouge">disabled</code> attribute on a
          <code className="highlighter-rouge">&lt;fieldset&gt;</code>. Use custom JavaScript to disable the fieldset in these browsers.</p>
      </div>
      <p>If you want to see more examples and properties please check the official <a
